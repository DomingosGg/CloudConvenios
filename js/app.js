(() => {
    ...
    // V8.5.0: recados padronizados preparados no Outlook Web.
              ...
              <form id="outlookMessageForm" novalidate>
                ...
                <div class="modal-body">
                  ...
                  <div class="form-grid">
                    ...
                    <div class="form-group full">
                      ...
                      <div style="display:flex;flex-wrap:wrap;gap:10px">
                        <label class="check-option" style="min-width:170px">
                          <input type="radio" name="outlookMessageBrand" value="Uniasselvi">
                          Uniasselvi
                        </label>
                        <label class="check-option" style="min-width:170px">
                          <input type="radio" name="outlookMessageBrand" value="Unicesumar">
                          Unicesumar
                        </label>
                      </div>
                    </div>
                  ...
                  <div id="outlookMessageValidation" class="summary-box" style="margin-top:14px">
                    Selecione a marca para gerar o recado.
                  </div>
                </div>
    ...
    function selectedOutlookBrand() {
      return document.querySelector('input[name="outlookMessageBrand"]:checked')?.value || '';
    }
    ...
    function refreshOutlookMessagePreview() {
      ...
      if (!brandOk) {
        setOutlookMessageValidation('Selecione Uniasselvi ou Unicesumar para preencher o recado.');
      } else if (!recipientOk) {
    ...
    function openOutlookMessage(companyId) {
      ...
      $('#outlookMessageModalSubtitle').textContent = `${outlookLocalName(company)} • ${company.situacao}`;

      document.querySelectorAll('input[name="outlookMessageBrand"]').forEach((input) => {
        input.checked = false;
      });
    ...
    function submitOutlookMessage(event) {
      ...
      if (!brand) {
        setOutlookMessageValidation('Selecione Uniasselvi ou Unicesumar.', 'error');
        return;
      }
    ...
    function renderContactsPanel() {
      ...
      if(c){
        ...
        $('#contactTimelineSubtitle').textContent=`${c.cnpj||'Sem CNPJ'} • ${c.cidade}/${c.estado}`;
    ...
    function bindEvents() {
      ...
      document.querySelectorAll('input[name="outlookMessageBrand"]').forEach((input)=>input.addEventListener('change',refreshOutlookMessagePreview));
