(() => {
    ...
    const CSV_HEADERS = ['Situação da Vigência','CNPJ','Razão Social','Nome Fantasia','Data de Abertura','Situação Cadastral','Natureza Jurídica','CNAE Principal (código e descrição)','CEP','Logradouro','Número','Complemento','Bairro','Estado','Cidade','E-mail','Telefone','Polo','Início da Vigência','Fim da Vigência','Dias restantes','Data do Cadastro','Vigência','Situação','Forma de Contato','Fonte do CNPJ','Última consulta do CNPJ','Observações'];
    ...
    const IMPORT_TEMPLATE_HEADERS = [
      'CNPJ','Razão Social','Nome Fantasia','Data de Abertura','Situação Cadastral',
      ...
      return workbookBlob([
        {
          ...
          widths: [20,32,28,16,22,28,34,12,28,10,20,20,10,22,30,18,20,18,18,18,24,24,40]
        },
        {
          name: 'Instruções',
          rows: instructions,
